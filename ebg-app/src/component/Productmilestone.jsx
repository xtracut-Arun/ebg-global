...
export default function Productmilestone({title, discription, distance, mode, slogan,below_slogan,col_heading ,col1_num,col1_metric,col1_text, col2_num,col2_metric,col2_text, col3_num,col3_metric,col3_text, col4_num,col4_metric,col4_text}) {
    return (
        <>
        <div className="container  mx-auto py-0 pt-20 md:py-20 ">
            <div className="text-center flex flex-col items-center">
            <h1>{title }</h1>
            <p className='md:w-[45%]'>{discription}</p>
            </div>
            ...
            <div className="container w-fit my-10 mx-auto  flex flex-col md:flex-row gap-10 md:gap-13 lg:gap-10  justify-center bg-[#E2E2E2] p-14 rounded-[50px]">
